    ...
    <div class="container">
      ...
      <form class="form-group" action="calculate.php" method="post">
        ...
        <div class="col-md-6">
          ...
          <input type="text" name="comida" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
          <label for="" class="label">Mudanza</label>
          <input type="text" name="mudanza" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
          <label for="" class="label">Material Actividades</label>
          <input type="text" name="material_actividades" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
          <label for="" class="label">Material General</label>
          <input type="text" name="material_general" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
          <label for="" class="label">Seguros</label>
          <input type="text" name="seguros" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
          <label for="" class="label">Playeras</label>
          <input type="text" name="playeras" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
          <label for="" class="label">Publicidad</label>
          <input type="text" name="" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
          <label for="" class="label">Cocineras</label>
          <input type="text" name="cocineras" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
          <label for="" class="label">Camiones</label>
          <input type="text" name="camiones" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
          <label for="" class="label">Paramedico</label>
          <input type="text" name="paramedico" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
          <label for="" class="label">Extras</label>
          <input type="text" name="extras" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
          <label for="" class="label">Becas</label>
          <input type="text" name="becas" value="" class="entrada form-control">
        </div>
        <div class="col-md-6">
